      ...
      {WAVE_HEIGHTS.map((h, i) => (
        <div
          ...
          style={{
            ...
            height: 14,
            borderRadius: 2,
            background: active ? "#CF3D88" : "rgba(255,228,184,0.18)",
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${isDark ? "rgba(255,228,184,0.22)" : "rgba(207,61,136,0.22)"}`,
                    boxShadow: d === 0
                ...
                >
                  {f.screenshot ? (
                    ...
                    <>
                      ...
                      <div style={{ flex: 1, borderRadius: 16, overflow: "hidden", minHeight: 0, marginBottom: 14, border: `1.5px solid ${isDark ? "rgba(255,228,184,0.14)" : "rgba(207,61,136,0.14)"}` }}>
                        <img
                          src={f.screenshot}
                          alt=""
                          loading="lazy"
...
const PRIVACY_BG_ICONS = [
  /* microphone — Your voice stays private */
  <svg key="mic" viewBox="0 0 60 96" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: "100%", height: "100%" }}>
    {/* capsule body */}
    <rect x="14" y="2" width="32" height="54" rx="16" />
    {/* sound waves / grille lines */}
    <line x1="22" y1="24" x2="38" y2="24" strokeWidth="1.8" opacity="0.7" />
    <line x1="22" y1="32" x2="38" y2="32" strokeWidth="1.8" opacity="0.7" />
    {/* stand neck */}
    <line x1="30" y1="56" x2="30" y2="76" strokeWidth="3" />
    {/* pickup arc */}
    <path d="M10 40 Q10 70 30 70 Q50 70 50 40" strokeWidth="2.5" fill="none" />
    {/* base */}
    <line x1="16" y1="80" x2="44" y2="80" strokeWidth="3" />
  </svg>,
  /* lined document — Your words */
  <svg key="doc" viewBox="0 0 72 90" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ width: "100%", height: "100%" }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            href="https://www.echobyreaclyse.com/privacy"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              fontFamily: C.sans,
...
function TestimonialsPlaceholder() {
  ...
  const cardBg = isDark ? "rgba(255,246,233,0.06)" : "rgba(207,61,136,0.04)";
      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <img src="/review-maya.webp" alt="Maya" style={{ width: 44, height: 44, borderRadius: "50%", objectFit: "cover", objectPosition: "center top", flexShrink: 0, display: "block", boxShadow: "0 2px 10px rgba(207,61,136,0.2)" }} />
            <div>
        ...
        {expanded && (
          ...
          >
            ...
            <div style={{ textAlign: "center", marginTop: 8 }}>
              <a
                href="https://www.echobyreaclyse.com/faq"
                target="_blank"
                rel="noopener noreferrer"
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {[
            { label: "Privacy", href: "https://www.echobyreaclyse.com/privacy" },
            { label: "GDPR", href: "https://www.echobyreaclyse.com/gdpr" },
            { label: "Support", href: "https://www.echobyreaclyse.com/support" },
          ].map(({ label, href }) => (
            <a
              key={href}
              href={href}
