...
const faqs = [
  ...
  },
  {
    ...
    a: "ÉCHO has a free tier with no time limit. PRO is €7.99 per month or €69 per year (a saving of about 28%). Members who join the waitlist before launch will receive a founding-member discount that locks in a lower rate for the lifetime of their subscription.",
  },
  {
